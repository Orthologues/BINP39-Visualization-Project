...
import { CardTitle, Button, ButtonGroup } from 'reactstrap';
...
const MolComponent: FC<any> = () => {
    ...
    const QueryList = (): JSX.Element => (
      <div className='pdb-query-list'>        
        <CardTitle tag="h5" style={{ marginTop: '8px' }}
        ...
        <ButtonGroup>
          ...
          active={molState.displayMode === 'latest'}>Latest AA-Clash query</Button>
          <Button className='btn-sm'
          color="info" onClick={ () => dispatch(switchMolListDisplayMode('history')) }
          active={molState.displayMode === 'history'}>History of AA-Clash queries</Button>
        </ButtonGroup>
        <CardTitle tag="h6"
